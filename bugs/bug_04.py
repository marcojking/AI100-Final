"""Bug 04: batch_size=1 causes BatchNorm1d to crash during training"""
...
train_loader = DataLoader(TensorDataset(X_train_t, y_train_t), batch_size=1, shuffle=True)  # BUG: batch_size=1
...
print("=== BUG 04: batch_size=1 with BatchNorm1d ===")
try:
    model.train()
