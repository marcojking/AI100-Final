"""Bug 05: FloatTensor for labels instead of LongTensor"""
...
y_train_t = torch.FloatTensor(y_train)   # BUG: should be LongTensor
...
print("=== BUG 05: FloatTensor labels instead of LongTensor ===")
try:
    model.train()
