"""Bug 10: model.eval() used during training instead of model.train()"""
...
print("=== BUG 10: model.eval() during training instead of model.train() ===")
EPOCHS = 5
...
print("\nNote: no crash, but Dropout is disabled and BatchNorm uses running stats during training,")
print("causing different (typically worse or misleadingly high) training behavior.")
